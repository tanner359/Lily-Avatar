Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/9e5fdfee379aca94a87615d41abf27ea"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float lineWidth = (0.15 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
				...
				emissionColor1 = hueShift(emissionColor1, frac((0.0 /*_EmissionHueShift1*/) + (0.0 /*_EmissionHueShiftSpeed1*/) * _Time.x) * (1.0 /*_EmissionHueShiftEnabled1*/), (0.0 /*_EmissionHueShiftColorSpace1*/));
				emissionColor1 = lerp(emissionColor1, dot(emissionColor1, float3(0.3, 0.59, 0.11)), - ((1.32 /*_EmissionSaturation1*/)) * (1.0 /*_EmissionHueShiftEnabled1*/));
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
