Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/637f1e357405ac245b9d570f4598f766"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.088 /*_AlphaMod*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((0.174 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
				...
				clip(poiFragData.alpha - (0.002 /*_Cutoff*/));
