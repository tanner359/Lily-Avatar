Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/898e8e8b34f975f4b9789efe4eca0f21"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (1.0 /*_OutlinesMaxDistance*/)), (1.0 /*_OutlineFixWidth*/));
				}
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#ifdef POI_PASS_OUTLINE
				shadowStrength = lerp(0, shadowStrength, (0.255 /*_OutlineShadowStrength*/));
				#endif
				#ifdef _LIGHTINGMODE_MULTILAYER_MATH
				#if defined(PROP_MULTILAYERMATHBLURMAP) || !defined(OPTIMIZER_ENABLED)
				...
				if (float4(0.8368256,0.6493458,0.641104,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.8368256,0.6493458,0.641104,1).rgb;
				}
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal3.m_DecalBlendType = (2.0 /*_DecalBlendType3*/);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcapIntensity = (3.77 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.23 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.55 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				{
					float mipCount2 = 9;
					if (float4(1,1,1,1).z == 8192) mipCount2 = 13;
					if (float4(1,1,1,1).z == 4096) mipCount2 = 12;
					if (float4(1,1,1,1).z == 2048) mipCount2 = 11;
					if (float4(1,1,1,1).z == 1024) mipCount2 = 10;
					if (float4(1,1,1,1).z == 512) mipCount2 = 9;
					if (float4(1,1,1,1).z == 256) mipCount2 = 8;
					if (float4(1,1,1,1).z == 128) mipCount2 = 7;
					if (float4(1,1,1,1).z == 64) mipCount2 = 6;
					if (float4(1,1,1,1).z == 32) mipCount2 = 5;
					...
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap2, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap2), matcap2Smoothness) * float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0,0,0,1).a);
				}
				else
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2)) * float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0,0,0,1).a);
				}
				#else
				matcap2 = float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0,0,0,1).a);
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), _Matcap2Multiply, _Matcap2Replace, (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP2
				...
				{
					float mipCount3 = 9;
					if (float4(1,1,1,1).z == 8192) mipCount3 = 13;
					if (float4(1,1,1,1).z == 4096) mipCount3 = 12;
					if (float4(1,1,1,1).z == 2048) mipCount3 = 11;
					if (float4(1,1,1,1).z == 1024) mipCount3 = 10;
					if (float4(1,1,1,1).z == 512) mipCount3 = 9;
					if (float4(1,1,1,1).z == 256) mipCount3 = 8;
					if (float4(1,1,1,1).z == 128) mipCount3 = 7;
					if (float4(1,1,1,1).z == 64) mipCount3 = 6;
					if (float4(1,1,1,1).z == 32) mipCount3 = 5;
					...
					matcap3 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap3, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap3), matcap3Smoothness) * float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0,0,0,1).a);
				}
				else
				{
					matcap3 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap3, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap3)) * float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0,0,0,1).a);
				}
				#else
				matcap3 = float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap3ColorThemeIndex*/)), float4(0,0,0,1).a);
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), _Matcap3Multiply, _Matcap3Replace, (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP3
				...
				{
					float mipCount4 = 9;
					if (float4(1,1,1,1).z == 8192) mipCount4 = 13;
					if (float4(1,1,1,1).z == 4096) mipCount4 = 12;
					if (float4(1,1,1,1).z == 2048) mipCount4 = 11;
					if (float4(1,1,1,1).z == 1024) mipCount4 = 10;
					if (float4(1,1,1,1).z == 512) mipCount4 = 9;
					if (float4(1,1,1,1).z == 256) mipCount4 = 8;
					if (float4(1,1,1,1).z == 128) mipCount4 = 7;
					if (float4(1,1,1,1).z == 64) mipCount4 = 6;
					if (float4(1,1,1,1).z == 32) mipCount4 = 5;
					...
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap4, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap4), matcap4Smoothness) * float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(0,0,0,1).a);
				}
				else
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4)) * float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(0,0,0,1).a);
				}
				#else
				matcap4 = float4(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(0,0,0,1).a);
				#endif
				...
				{
					matcap4.rgb = hueShift(matcap4.rgb, (0.0 /*_Matcap4HueShift*/) + _Time.x * (0.0 /*_Matcap4HueShiftSpeed*/), (0.0 /*_Matcap4HueShiftColorSpace*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), _Matcap4Multiply, _Matcap4Replace, (0.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef _CUBEMAP
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				cubeMap.rgb *= (1.11 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (1000.0 /*_GlitterFrequency*/);
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (25.1 /*_GlitterAngleRange*/), (10.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
							randomRotation = randomFloat3Range(randoPoint, (25.1 /*_GlitterAngleRange*/));
						}
						float3 glitterReflectionDirection = normalize(mul(poiRotationMatrixFromAngles(randomRotation), norm));
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.85 /*_GlitterBias*/)), poiCam.viewDir)), (151.0 /*_GlitterContrast*/)), 0);
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (151.0 /*_GlitterContrast*/)), 0);
						glitterColor *= poiLight.directColor;
						finalGlitter *= glitterAlpha;
						break;
					}
					glitterColor *= lerp(1, poiFragData.baseColor, (0.5 /*_GlitterUseSurfaceColor*/));
					#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
			...
			void applyEnvironmentRim(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				(0.392 /*_RimEnviroBlur*/) *= 1.7 - 0.7 * (0.392 /*_RimEnviroBlur*/);
				float3 enviroRimColor = 0;
				float interpolator = unity_SpecCube0_BoxMin.w;
				
				if (interpolator < 0.99999)
				{
					float4 reflectionData0 = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, poiMesh.normals[1], (0.392 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
					float3 reflectionColor0 = DecodeHDR(reflectionData0, unity_SpecCube0_HDR);
					float4 reflectionData1 = UNITY_SAMPLE_TEXCUBE_SAMPLER_LOD(unity_SpecCube1, unity_SpecCube0, poiMesh.normals[1], (0.392 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
				...
				{
					float4 reflectionData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, poiMesh.normals[1], (0.392 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRim2Light*/), (1.0 /*_Rim2LightingInvert*/), (0.6 /*_Rim2Power*/), (0.0 /*_Rim2Strength*/), (0.0 /*_Rim2ShadowWidth*/), (0.0 /*_Rim2ShadowToggle*/), (0.201 /*_Rim2Width*/), (0.64 /*_Rim2BlendStrength*/), rim2Mask, (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), rim2Color, float4(1,1,1,1), (0.0 /*_Rim2LightColorThemeIndex*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftColorSpace*/), (0.0 /*_Rim2HueShiftSpeed*/), (0.0 /*_Rim2Sharpness*/), (0.0 /*_Rim2ShadowMaskRampType*/), (0.0 /*_Rim2ShadowMaskInvert*/), (1.0 /*_Rim2ShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_Rim2ApplyGlobalMaskIndex*/), (2.0 /*_Rim2ApplyGlobalMaskBlendType*/), (1.0 /*_Rim2BaseColorMix*/), (2.44 /*_Rim2Brightness*/), (0.0 /*_RimPoi2BlendMode*/), AudioLinkRim2WidthBand, AudioLinkRim2WidthAdd, AudioLinkRim2EmissionBand, AudioLinkRim2EmissionAdd, AudioLinkRim2BrightnessBand, AudioLinkRim2BrightnessAdd, rim2Bias, (0.0 /*_Rim2BiasIntensity*/), (0 /*_Rim2ApplyAlpha*/), (1.0 /*_Rim2ApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.2844405,0.1120194,0.1120194,1);
				#ifdef POI_AUDIOLINK
