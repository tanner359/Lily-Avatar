Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/b916d944d88613a449018156216cc282"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalColor = float4(0.003851597,0.003851597,0.003851597,1);
				...
				Decal1.m_DecalColor = float4(0.01896324,0.01896324,0.01896324,1);
				...
				Decal2.m_DecalColor = float4(0.02070686,0.02070686,0.02070686,1);
				...
				Decal3.m_DecalColor = float4(0.003851593,0.003851593,0.003851593,1);
