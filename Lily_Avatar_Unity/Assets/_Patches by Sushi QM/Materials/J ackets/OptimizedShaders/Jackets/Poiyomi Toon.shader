Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ba12238dd1630a748ae60c0abe7118b3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal1.m_DecalColor = float4(0.5007474,0.5007474,0.5007474,1);
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.0 /*_AudioLinkEmission1CenterOutSize*/), (0.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0,2,0,0), (1.0 /*_EmissionAL1Enabled*/), (1.0 /*_AudioLinkEmission1CenterOutDuration*/));
				...
				#if defined(PROP_EMISSIONMAP1) || !defined(OPTIMIZER_ENABLED)
				if (!(1.0 /*_EmissionCenterOutEnabled1*/))
				{
				...
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(2,2,2,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
