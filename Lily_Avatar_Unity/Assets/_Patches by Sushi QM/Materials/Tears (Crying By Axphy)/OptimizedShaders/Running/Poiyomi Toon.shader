Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/226d8177c0b20234b89bf17fa35c3127"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.00998 /*_AlphaMod*/));
			...
			float2 distortedUV(in PoiMesh poiMesh)
			{
				...
				#endif
				half distortionStrength = (0.008 /*_DistortionStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, mainUV, float4(0,10,0,0), (0.0 /*_MainTexStochastic*/));
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(7.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,10,0,0), (0.0 /*_BumpMapStochastic*/)), (1.0 /*_BumpScale*/));
				#else
				...
				clip(poiFragData.alpha - (0.053 /*_Cutoff*/));
