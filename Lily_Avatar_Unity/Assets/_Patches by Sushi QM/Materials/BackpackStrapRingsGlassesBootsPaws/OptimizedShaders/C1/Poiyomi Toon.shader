Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/2b68bfa1cecabe74cbdeedd48dbe61ab"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((0.0 /*_UDIMDiscardMode*/) == 0) // Discard Vertices instead of just pixels
				{
					...
					isDiscarded += (udim.y >= 1 && udim.y < 2) * dot(float4((0.0 /*_UDIMDiscardRow1_0*/), (0.0 /*_UDIMDiscardRow1_1*/), (0.0 /*_UDIMDiscardRow1_2*/), (1.0 /*_UDIMDiscardRow1_3*/)), xMask);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveToTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DissolveTextureColorThemeIndex*/)), float4(1,1,1,1).a);
				#else
