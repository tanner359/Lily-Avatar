Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/8b13e205cd307c644a7af944673623cb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					float2 udim = 0;
					udim += (v.uv0.xy * ((2.0 /*_UDIMDiscardUV*/) == 0));
					udim += (v.uv1.xy * ((2.0 /*_UDIMDiscardUV*/) == 1));
					udim += (v.uv2.xy * ((2.0 /*_UDIMDiscardUV*/) == 2));
					udim += (v.uv3.xy * ((2.0 /*_UDIMDiscardUV*/) == 3));
					float isDiscarded = 0;
				...
				if ((1.0 /*_UVTileDissolveEnabled*/) && (1.0 /*_UVTileDissolveDiscardAtMax*/))
				{
					float2 dissolveUdim = 0;
					dissolveUdim += (v.uv0.xy * ((3.0 /*_UVTileDissolveUV*/) == 0));
					dissolveUdim += (v.uv1.xy * ((3.0 /*_UVTileDissolveUV*/) == 1));
					dissolveUdim += (v.uv2.xy * ((3.0 /*_UVTileDissolveUV*/) == 2));
					dissolveUdim += (v.uv3.xy * ((3.0 /*_UVTileDissolveUV*/) == 3));
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 0 && dissolveUdim.y < 1) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row0_0*/), _UVTileDissolveAlpha_Row0_1, (0.0 /*_UVTileDissolveAlpha_Row0_2*/), (0.0 /*_UVTileDissolveAlpha_Row0_3*/)), xMaskDissolve);
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				...
				{
					float dither = calcDither(poiCam.posScreenPixels) - (1.0 /*_AlphaDitherBias*/);
					poiFragData.alpha = saturate(poiFragData.alpha - (dither * (1 - poiFragData.alpha) * (0.0 /*_AlphaDitherGradient*/)));
				}
			}
			...
			void applyUDIMDiscard(in VertexOut i)
			{
				...
				{
					float2 udim = floor(vertexUV(i, (2.0 /*_UDIMDiscardUV*/)));
					float isDiscarded = 0;
					float4 xMask = float4(  (udim.x >= 0 && udim.x < 1),
					(udim.x >= 1 && udim.x < 2),
					(udim.x >= 2 && udim.x < 3),
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (1.0 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (1.0 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r, (1.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (1.0 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (1.0 /*_ShadowBorder*/), (1.0 /*_ShadowBlur*/) * blurMap.r, (1.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if (float4(0.5007474,0.4252422,0.4223709,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.5007474,0.4252422,0.4223709,1).rgb;
				}
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(1,0.6781116,0.6529142,1).rgb * float4(1,0.6781116,0.6529142,1).a);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalHueShiftEnabled = (1.0 /*_DecalHueShiftEnabled*/);
				...
				Decal2.m_DecalScale = float4(1,1,1,0);
				...
				Decal2.m_DecalHueShiftEnabled = (1.0 /*_DecalHueShiftEnabled2*/);
				...
				Decal3.m_DecalHueShiftEnabled = (1.0 /*_DecalHueShiftEnabled3*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				if ((1.0 /*_UVTileDissolveEnabled*/))
				{
					float2 udim = floor(poiMesh.uv[(int)(3.0 /*_UVTileDissolveUV*/)]);
					float4 xMask = float4((udim.x >= 0 && udim.x < 1),
					(udim.x >= 1 && udim.x < 2),
					(udim.x >= 2 && udim.x < 3),
					(udim.x >= 3 && udim.x < 4));
					da += (udim.y >= 0 && udim.y < 1) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row0_0*/), _UVTileDissolveAlpha_Row0_1, (0.0 /*_UVTileDissolveAlpha_Row0_2*/), (0.0 /*_UVTileDissolveAlpha_Row0_3*/)), xMask);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcapIntensity = (0.79 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.123 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.618 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP2
				...
				#endif
				matcapIntensity = (1.39 /*_Matcap3Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				matcap3.rgb = lerp(matcap3.rgb, matcap3.rgb * poiFragData.baseColor.rgb, (0.939 /*_Matcap3BaseColorMix*/));
				#if defined(PROP_MATCAP3MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.0 /*_Matcap3Multiply*/), (0.0 /*_Matcap3Replace*/), (0.482 /*_Matcap3Mixed*/), (0.488 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP3
				...
				#if defined(PROP_MATCAP4) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_Matcap4UVMode*/), (1.0 /*_Matcap4UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap4Rotation*/), (0.43 /*_Matcap4Border*/), normal3, poiCam, poiLight, poiMesh, (1.0 /*_Matcap4Normal*/), matcapALD);
				if ((0.0 /*_Matcap4SmoothnessEnabled*/))
				{
					float mipCount4 = 9;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 8192) mipCount4 = 13;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 4096) mipCount4 = 12;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 2048) mipCount4 = 11;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 1024) mipCount4 = 10;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 512) mipCount4 = 9;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 256) mipCount4 = 8;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 128) mipCount4 = 7;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 64) mipCount4 = 6;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 32) mipCount4 = 5;
				...
				#endif
				matcapIntensity = (0.93 /*_Matcap4Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				matcap4.rgb = lerp(matcap4.rgb, matcap4.rgb * poiFragData.baseColor.rgb, (0.939 /*_Matcap4BaseColorMix*/));
				#if defined(PROP_MATCAP4MASK) || !defined(OPTIMIZER_ENABLED)
				...
				{
					matcap4.rgb = hueShift(matcap4.rgb, (0.0 /*_Matcap4HueShift*/) + _Time.x * (0.0 /*_Matcap4HueShiftSpeed*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.0 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (0.482 /*_Matcap4Mixed*/), (0.488 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef _CUBEMAP
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				cubeMap.rgb *= (1.71 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				{
					cubeMap.rgb = hueShift(cubeMap.rgb, (0.0 /*_CubeMapHueShift*/) + _Time.x * (0.0 /*_CubeMapHueShiftSpeed*/));
					cubeMap = PoiColorBCS(cubeMap, (0.0 /*_CubeMapBrightness*/), (1.0 /*_CubeMapContrast*/), (1.0 /*_CubeMapSaturation*/));
				}
				CubeMapMask = min(CubeMapMask, lerp(1, poiLight.rampedLightMap, (0.69 /*_CubeMapLightMask*/)));
				float cubeMapAlpha = CubeMapMask * cubeMap.a * (0.511 /*_CubeMapBlendAmount*/);
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, _EmissionColor1.rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, _EmissionColor1.rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, _EmissionColor1.rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, _EmissionColor2.rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, _EmissionColor2.rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, _EmissionColor2.rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				...
				emissionColor2 = hueShift(emissionColor2, frac(_EmissionHueShift2 + (0.0 /*_EmissionHueShiftSpeed2*/) * _Time.x) * (1.0 /*_EmissionHueShiftEnabled2*/));
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength3 = (1.0 /*_EmissionStrength3*/);
				...
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(2.670157,2.670157,2.670157,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(2.670157,2.670157,2.670157,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(2.670157,2.670157,2.670157,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				...
				emissionColor3 = lerp(emissionColor3, dot(emissionColor3, float3(0.3, 0.59, 0.11)), - ((0.0 /*_EmissionSaturation3*/)) * (0.0 /*_EmissionHueShiftEnabled3*/));
				#if defined(PROP_EMISSIONMASK3) || !defined(OPTIMIZER_ENABLED)
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (600.0 /*_GlitterFrequency*/);
					...
					half3 glitterColor = poiThemeColor(poiMods, float4(0.3590651,2,0,1).rgb, (0.0 /*_GlitterColorThemeIndex*/));
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (0.0 /*_GlitterAngleRange*/), (10.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
							randomRotation = randomFloat3Range(randoPoint, (0.0 /*_GlitterAngleRange*/));
						}
					...
					glitterMask *= float4(0.3590651,2,0,1).a;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((2.0 /*_MainAlphaMaskMode*/))
				{
					...
					if ((1.0 /*_AlphaMaskInvert*/)) alphaMask = 1 - alphaMask;
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (1.36 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (1.0 /*_RimWidth*/), (0.625 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0.3837283,0.3837283,0.3837283,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.305 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (1.0 /*_RimBaseColorMix*/), (1.31 /*_RimBrightness*/), (2.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef POI_RIM2
				#ifdef _RIM2STYLE_POIYOMI
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRim2Light*/), (0.0 /*_Rim2LightingInvert*/), (1.0 /*_Rim2Power*/), (0.0 /*_Rim2Strength*/), (0.0 /*_Rim2ShadowWidth*/), (0.0 /*_Rim2ShadowToggle*/), (0.462 /*_Rim2Width*/), (1.0 /*_Rim2BlendStrength*/), rim2Mask, (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), rim2Color, float4(1,1,1,1), (0.0 /*_Rim2LightColorThemeIndex*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftSpeed*/), (0.117 /*_Rim2Sharpness*/), (0.0 /*_Rim2ShadowMaskRampType*/), (0.0 /*_Rim2ShadowMaskInvert*/), (1.0 /*_Rim2ShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_Rim2ApplyGlobalMaskIndex*/), (2.0 /*_Rim2ApplyGlobalMaskBlendType*/), (0.0 /*_Rim2BaseColorMix*/), (2.12 /*_Rim2Brightness*/), (2.0 /*_RimPoi2BlendMode*/), AudioLinkRim2WidthBand, AudioLinkRim2WidthAdd, AudioLinkRim2EmissionBand, AudioLinkRim2EmissionAdd, AudioLinkRim2BrightnessBand, AudioLinkRim2BrightnessAdd, rim2Bias, (0.0 /*_Rim2BiasIntensity*/), (0 /*_Rim2ApplyAlpha*/), (1.0 /*_Rim2ApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
